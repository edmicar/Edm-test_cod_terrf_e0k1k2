...
data "aws_iam_instance_profile" "eks_worker_group_iam_instance_profile" {
...
data "aws_iam_instance_profile" "eks_worker_group_launch_template_iam_instance_profile" {
