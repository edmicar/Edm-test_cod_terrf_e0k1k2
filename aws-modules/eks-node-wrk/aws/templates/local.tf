locals {
  ...
  cluster_iam_role_arn      = var.roletfeks_id

  default_iam_role_id = var.roletfeks_id
  ...
  workers_group_defaults_defaults = {
    ...
    asg_min_size                  = "1"                         # Minimum worker capacity in the autoscaling group. NOTE: Change in eks paramater will affect the asg_desired_capacity, like changing its value to 2 will change asg_desired_capacity value to 2 but bringing back it to 1 will not affect the asg_desired_capacity.
